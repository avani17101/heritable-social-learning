...
> **Post-run fairness audit (2026-09-19): preliminary results.** The fixed
> baseline's initial training-screen evaluation reused its learning trajectories
> through the `tune_train` seed namespace. Subsequent validation and final test
> trajectories were independent. Correct the screening split before a
> confirmatory comparison; also match search effort and the selection objective.
> The original numbers and source snapshots below are preserved unchanged.
...
![01_fitness](../../figures/archive_screen_reuse/01_fitness.png)

![02_regret](../../figures/archive_screen_reuse/02_regret.png)

![03_shift](../../figures/archive_screen_reuse/03_shift.png)

![04_genome_trajectory](../../figures/archive_screen_reuse/04_genome_trajectory.png)

![05_genome_distribution](../../figures/archive_screen_reuse/05_genome_distribution.png)

![06_lineage](../../figures/archive_screen_reuse/06_lineage.png)

![07_transfer](../../figures/archive_screen_reuse/07_transfer.png)

![08_generalization](../../figures/archive_screen_reuse/08_generalization.png)

![09_behavior](../../figures/archive_screen_reuse/09_behavior.png)
